...
% Custom fontsize of headings --------------------------------------------------------------
\newcommand{\size}[2]{{\fontsize{#1}{0}\selectfont#2}}

% Tombstone symbol as q.e.d --------------------------------------------------------------
...
\newlist{listofnotation}{itemize}{1}
\setlist[listofnotation,1]{label=,labelwidth=1in,align=parleft,itemsep=0.1\baselineskip,leftmargin=!}
