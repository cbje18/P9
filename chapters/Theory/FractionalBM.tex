...
We will now give the process defined in Theorem \ref{existencethm} the name of \textit{fractional Brownian motion}.%We will now define a fractional Brownian motion as the process, which existence is given by Theorem \ref{existencethm}.
